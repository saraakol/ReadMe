...
<!--                    <label for="img" class="custom-file-upload">
                    ...
                    <br><br>
                    <input type="button" data-toggle="modal" data-target="#exampleModal" value="Continue"></input>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Quote added</h5>
                          <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>-->
                        </div>
                        <div class="modal-body">
                         Your quote was successfully added!
                        </div>
