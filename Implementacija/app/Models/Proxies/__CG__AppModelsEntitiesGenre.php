 ...
 */
class Genre extends \App\Models\Entities\Genre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Genre' . "\0" . 'idg', '' . "\0" . 'App\\Models\\Entities\\Genre' . "\0" . 'name', '' . "\0" . 'App\\Models\\Entities\\Genre' . "\0" . 'books', '' . "\0" . 'App\\Models\\Entities\\Genre' . "\0" . 'users'];
        }
