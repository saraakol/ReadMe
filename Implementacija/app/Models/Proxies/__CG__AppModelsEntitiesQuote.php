 ...
 */
class Quote extends \App\Models\Entities\Quote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Quote' . "\0" . 'idq', '' . "\0" . 'App\\Models\\Entities\\Quote' . "\0" . 'text', '' . "\0" . 'App\\Models\\Entities\\Quote' . "\0" . 'idu', '' . "\0" . 'App\\Models\\Entities\\Quote' . "\0" . 'idb'];
        }
    ...
    public function getIdq()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdq();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdq', []);

        return parent::getIdq();
    }
